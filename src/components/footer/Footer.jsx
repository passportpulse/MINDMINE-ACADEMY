    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-col">
          ...
          <ul>
            <li>
              <a href="/">GNM Nursing</a>
            </li>
            <li>
              <a href="/">Data Science with AI</a>
            </li>
            <li>
              <a href="/">Multimedia & Animation & VFX</a>
            </li>
            <li>
              <a href="/">Software Development & Web Technology</a>
            </li>
            <li>
              <a href="/">B.Voc Graduation Programs</a>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          ...
          <p className="footer-item">
            ...
            Maharaja Agrasain Dham,
            <br />
            Near Ghoraghata Railway Station,
            <br />
          ...
          <p className="footer-item">
            ...
            <a href="tel:7595077569">7595077569</a> /{" "}
            <a href="tel:6289086116">6289086116</a>
          </p>
